          ...
          <button
              ...
              className={`flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-medium border transition-all
                ${currentStep === 1
                  ...
                  : "border-black/20 text-black/60 hover:border-black/40 hover:text-[#0A0A0A] cursor-pointer"
                }`}
            >
              <FiArrowLeft size={15} />
            ...
            <div className="flex items-center gap-1.5 ">
              {STEPS.map((s) => (
                <button
                  ...
                  className={`rounded-full cursor-pointer transition-all ${s.step === currentStep
                    ? "w-4 h-1.5 bg-[#0A0A0A] "
                    : s.step < currentStep
