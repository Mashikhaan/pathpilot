...
const Scorer = () => {
 ...
 useEffect(() => {
  ...
  // Ye decide karega ki upload screen dikhani hai ya result screen
...
<motion.nav
  ...
  className="fixed left-0 top-0 z-50 w-full border-b border-white/10 bg-black"
>
