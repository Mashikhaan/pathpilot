    ...
    return (
      <div className="flex flex-col gap-3">
        ...
        <Input
          ...
          placeholder="mohd.masihulla@pm.me"
        />
        {/* Phone */}
        <Input
          label="Phone"
        ...
        <Input
          ...
          placeholder="https://linkedin.com/masihulla"
        />
        {/* GitHub */}
        <Input
          label="GitHub"
          value={data.github}
          onChange={(github) => setData({ ...data, github })}
          placeholder="https://github.com/masihulla"
        />
      </div>
    );
  }
      ...
      <div className="flex flex-col gap-3">
        ...
        {data.projects.map((proj, index) => (
          <EntryCard key={index} onRemove={() => removeProject(index)}>
            ...
            <Input label="GitHub Link"  value={proj.github}    onChange={(v) => updateProject(index, "github", v)}    placeholder="github.com/mashikhan/interviewos" />
